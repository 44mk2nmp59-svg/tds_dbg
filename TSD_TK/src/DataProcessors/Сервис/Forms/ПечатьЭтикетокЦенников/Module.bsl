...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементовФормы(ЭтаФорма, "ПодборТоваров, СканированиеШтрихкода, ДобавитьИзГруппыТоваров", "ЦветРамки", ЦветаСтиля.ЦветФонаФормы);
