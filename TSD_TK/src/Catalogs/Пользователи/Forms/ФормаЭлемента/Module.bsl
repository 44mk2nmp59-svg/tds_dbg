...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементовФормы(ЭтаФорма, "УдалитьПользователя, СнятьПометкуУдаления", "ЦветРамки", ЦветаСтиля.ЦветФонаФормы);
	...
	Если НЕ АдминистративныйРежим Тогда
		...
		Если НЕ ЗначениеЗаполнено(Объект.Ссылка) Тогда
			...
			ТекстСообщения = НСтр("ru = 'Для редактирования необходимо включить административный режим (Настройки).'");
