...
Процедура ПровестиФорматноЛогическийКонтроль(ОбщиеПараметры, ПодключаемоеОборудование) Экспорт
	...
	Если СтандартнаяОбработка Тогда
		...
		ПараметрыФорматноЛогическогоКонтроля = ФорматноЛогическийКонтрольВызовСервера.СтруктураДанныхФорматноЛогическогоКонтроля(ПодключаемоеОборудование);
		СпособФорматноЛогическогоКонтроля = ПараметрыФорматноЛогическогоКонтроля.СпособФорматноЛогическогоКонтроля;
		ДопустимоеРасхождение            = ПараметрыФорматноЛогическогоКонтроля.ДопустимоеРасхождениеФорматноЛогическогоКонтроля;
...
//
// Параметры:
//  ТекущаяПозиция - Произвольный, Структура - Текущая позиция
// 
// Возвращаемое значение:
//  Структура:
//   * Наименование - Строка.
//
Функция СкопироватьСтруктуру(ТекущаяПозиция) 
