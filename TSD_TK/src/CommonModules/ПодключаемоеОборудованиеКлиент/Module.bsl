...
Процедура ПолучитьТовар(ДополнительныеПараметры) Экспорт
	...
	Штрихкод = 0;//"";
	ОписаниеОповещения = Новый ОписаниеОповещения("ОповещениеПоискаПоШтрихкодуПК", ЭтотОбъект, ДополнительныеПараметры);
	ПоказатьВводЧисла(ОписаниеОповещения, Штрихкод, ЗаголовокСканирования);
...
Процедура ИнициализироватьАсинхронныйСканер(Форма) Экспорт
...
Процедура ОповещениеПоискаПоШтрихкодуПК(Результат, ДополнительныеПараметры) Экспорт
	...
	Если НЕ Результат = Неопределено Тогда
		Попытка 
			Рез = 	Формат(Результат,"ЧЦ=15; ЧГ=");
		Исключение
			Рез = Результат;
		КонецПопытки;
		
		
		ДополнительныеПараметры.Форма.ОбработатьПолученныйШтрихкод(Рез, ДополнительныеПараметры);
