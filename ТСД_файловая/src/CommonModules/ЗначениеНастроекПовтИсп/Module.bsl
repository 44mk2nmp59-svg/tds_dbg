...
Функция ФорматЦелоеЧисло()Экспорт
	Возврат "ЧЦ=4; ЧДЦ=0; ЧН=0; ЧГ=";
КонецФункции

Функция ФорматВес()Экспорт
	Возврат "ЧЦ=15; ЧДЦ=3; ЧН=0.000; ЧРД=.; ЧГ=0";
КонецФункции
...
//   Строка
//
Функция ФорматДатыДата() Экспорт
...
Функция ЦенаВключаетНДС() Экспорт
	...
	ЦенаВключаетНДС = Истина;//СистемаНалогообложения = Перечисления.СистемыНалогообложения.Общая;
...
Функция ЗагружатьЗаказы() Экспорт
	
	ЗагружатьНастройки = ЗначениеНастроекВызовСервераПовтИсп.ИспользуютсяЗаказыКлиентов();
