...
Функция ПолучитьПризнакПредметаРасчетаПоКоду(КодПризнакаПредметаРасчета) Экспорт
	...
	Возврат Перечисления.ПризнакиПредметаРасчета.ПолучитьПризнакПредметаРасчетаПоКоду(КодПризнакаПредметаРасчета);
	
КонецФункции

Функция ПолучитьПризнакАгентаПоКоду(КодПризнакаАгента) Экспорт
	
	Возврат Перечисления.ПризнакиАгента.ПолучитьПризнакАгентаПоКоду(КодПризнакаАгента);
