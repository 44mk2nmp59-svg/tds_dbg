...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ЗапретИзмененияДрайвера И ПустаяСтрока(Объект.РабочееМесто) Тогда
...
#Если МобильноеПриложениеСервер Тогда
	...
	Элементы.НастроитьКнопка.Видимость = Истина;
#Иначе
	Элементы.Настроить.Видимость = Истина ;
	Элементы.РабочееМесто.Видимость = Истина;
	Элементы.НастроитьКнопка.Видимость = Ложь;
#КонецЕсли
...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	Если НЕ МенеджерОборудованияКлиентПереопределяемый.РазрешитьНесколькоЭкземпляровОдногоТипаОборудования() Тогда
